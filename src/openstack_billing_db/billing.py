...
def collect_invoice_data_from_openstack(database, billing_start, billing_end, rates, invoice_month=None):
    invoices = []
...
def generate_billing(
    ...
    invoices = collect_invoice_data_from_openstack(database, invoice_month, start, end, rates)
